...
import { 
  ...
  BrainCircuit, Search, Database, Globe, Scale, 
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden font-sans text-slate-800">
      ...
      <section className="relative pt-40 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center z-10 space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/50 border border-white/60 backdrop-blur-md text-xs font-bold text-neon-blue-deep uppercase tracking-wider shadow-sm mb-4">
      ...
      <section id="features" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
           ...
           <div className="grid grid-cols-1 md:grid-cols-6 gap-6 auto-rows-[300px]">
              ...
              <div className="glass-panel p-8 rounded-[2.5rem] md:col-span-4 relative overflow-hidden group hover:bg-glass-whiteHover transition-all duration-500">
              ...
              <div className="glass-panel p-8 rounded-[2.5rem] md:col-span-2 md:row-span-2 relative overflow-hidden group hover:bg-glass-whiteHover transition-all duration-500 flex flex-col">
              ...
              <div className="glass-panel p-8 rounded-[2.5rem] md:col-span-2 relative overflow-hidden group hover:bg-glass-whiteHover transition-all duration-500">
              ...
              <div className="glass-panel p-8 rounded-[2.5rem] md:col-span-6 relative overflow-hidden group hover:bg-glass-whiteHover transition-all duration-500 flex items-center justify-between">
          ...
          <div className="max-w-5xl mx-auto">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                 ...
                 <div className="relative z-10 flex flex-col items-center text-center">
                    <div className="w-24 h-24 rounded-[2rem] bg-white border border-slate-100 shadow-xl flex items-center justify-center mb-6 relative">
